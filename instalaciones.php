      ...
      <div class="col-sm-6 col-md-6 col-lg-4 school">
         <div class="portfolio-item">
            <div class="gallery-thumb">
               ...
               <span class="overlay-mask"></span>
               <a href="img/gallery/instalaciones/instalacion02.jpg" class="link centered" title="You can add caption to pictures.">
               <i class="fa fa-expand"></i></a>
            </div>
         </div>
      </div>
      ...
      <div class="col-sm-6 col-md-6 col-lg-4 school">
         <div class="portfolio-item">
            <div class="gallery-thumb">
               ...
               <span class="overlay-mask"></span>
               <a href="img/gallery/instalaciones/instalacion03.jpg" class="link centered" title="You can add caption to pictures.">
               <i class="fa fa-expand"></i></a>
            </div>
         </div>
      </div>
      ...
      <div class="col-sm-6 col-md-6 col-lg-4 activities">
         <div class="portfolio-item">
            <div class="gallery-thumb">
               ...
               <span class="overlay-mask"></span>
               <a href="img/gallery/instalaciones/instalacion04.jpg" class="link centered" title="You can add caption to pictures.">
               <i class="fa fa-expand"></i></a>
            </div>
         </div>
      </div>
      ...
      <div class="col-sm-6 col-md-6 col-lg-4 school">
         <div class="portfolio-item">
            <div class="gallery-thumb">
               ...
               <span class="overlay-mask"></span>
               <a href="img/gallery/instalaciones/instalacion05.jpg" class="link centered" title="You can add caption to pictures.">
               <i class="fa fa-expand"></i></a>
            </div>
         </div>
      </div>
      ...
      <div class="col-sm-6 col-md-6 col-lg-4 school">
         <div class="portfolio-item">
            <div class="gallery-thumb">
               ...
               <span class="overlay-mask"></span>
               <a href="img/gallery/instalaciones/instalacion10.jpg" class="link centered" title="You can add caption to pictures.">
               <i class="fa fa-expand"></i></a>
            </div>
         </div>
      </div>

...
<!-- Mirrored from www.ingridkuhn.com/themes/abctots/404_boxed.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Oct 2021 16:05:30 GMT -->
      ...
      <div class="row">
         <div class="col-lg-12">
            <div class="predefined_styles">
               ...
               <a href="kindergarten.html" class="styleswitch"><img src="switcher/images/kindergarten.png" alt=""></a>		
               <a href="preschool.html" class="styleswitch"><img src="switcher/images/preschool.png" alt=""></a>
               <a href="playtime.html" class="styleswitch"><img src="switcher/images/playtime.png" alt=""></a>	
            </div>
 <div class="row">
      ...
      <nav id="main-nav" class="navbar-expand-xl fixed-top">
         <div class="row">
            ...
            <div class="navbar container-fluid">
               <div class="container ">
                  <!-- logo -->
                  <a class="nav-brand" href="index_boxed.html">
                  ...
                  <div class="collapse navbar-collapse" id="navbarResponsive">
                     <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item home-menu">
                           <a class="nav-link" href="index_boxed.html">Home
                           </a>
                        </li>
                        <!-- menu item -->
                        <li class="nav-item dropdown">
                           ...
                           <div class="dropdown-menu" aria-labelledby="services-dropdown">
                              <a class="dropdown-item" href="services_boxed.html">Services Style 1</a>
                              <a class="dropdown-item" href="services2_boxed.html">Services Style 2</a>
                              <a class="dropdown-item" href="services-single_boxed.html">Services Single</a>
                           </div>
                        </li>
                        <!-- menu item -->
                        <li class="nav-item dropdown">
                           ...
                           <div class="dropdown-menu" aria-labelledby="about-dropdown">
                              <a class="dropdown-item" href="about_boxed.html">About Style 1</a>
                              <a class="dropdown-item" href="about2_boxed.html">About Style 2</a>
                              <a class="dropdown-item" href="team_boxed.html">Our Team</a>
                              <a class="dropdown-item" href="team-single_boxed.html">Team Single Page</a>
                              <a class="dropdown-item" href="careers_boxed.html">Careers</a>
                              <a class="dropdown-item" href="pricing_boxed.html">Pricing</a>
                           </div>
                        </li>
                        <!-- menu item -->
                        <li class="nav-item dropdown">
                           ...
                           <div class="dropdown-menu" aria-labelledby="gallery-dropdown">
                              <a class="dropdown-item" href="gallery_boxed.html">Gallery Style 1</a>
                              <a class="dropdown-item" href="gallery2_boxed.html">Gallery Style 2</a>
                              <a class="dropdown-item" href="gallery3_boxed.html">Gallery Style 3</a>
                           </div>
                        </li>
                        <!-- menu item -->
                        <li class="nav-item dropdown">
                           ...
                           <div class="dropdown-menu" aria-labelledby="contact-dropdown">
                              <a class="dropdown-item" href="contact_boxed.html">Contact Style 1</a>
                              <a class="dropdown-item" href="contact2_boxed.html">Contact Style 2</a>
                              <a class="dropdown-item" href="contact3_boxed.html">Contact Style 3</a>
                           </div>
                        </li>
                        <!-- menu item -->
                        <li class="nav-item dropdown">
                           ...
                           <div class="dropdown-menu" aria-labelledby="others-dropdown">
                              <a class="dropdown-item" href="blog_boxed.html">Blog Home 1</a>
                              <a class="dropdown-item" href="blog2_boxed.html">Blog Home 2</a>
                              <a class="dropdown-item" href="blog-single_boxed.html">Blog Single</a>
                              <a class="dropdown-item" href="elements_boxed.html">Elements Page</a>
                              <a class="dropdown-item" href="404_boxed.php">404 Page</a>
                           </div>
                        </li>
                     </ul>
                     <!--/ul -->
...
#top {
    ...
    background:#fff; /* Body background color here*/
}
#top .navbar, 
#top .top-bar,                        
#top #slider,
      ...
      <div class="row text-lg-left text-center">
         ...
         <div class="col-lg-5" data-aos="fade-down">
            ...
            <div class="text-lg-left">
               <!-- button -->
               <a href="https://www.ingridkuhn.com/" class="btn btn-secondary btn-sm mt-4">Back to home page</a>
            </div>
         </div>
         <!-- /col-lg -->
      </div>

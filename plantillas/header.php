...
<head>
    ...
    <link href="<?php echo $path; ?>https://fonts.googleapis.com/css?family=Source+Sans+Pro:400,600,700&display=swap" rel="stylesheet">
    <link href="<?php echo $path; ?>https://fonts.googleapis.com/css?family=Nunito:400,700,900&display=swap" rel="stylesheet">
    ...
    <!-- plugins CSS -->
    <link href="<?php echo $path; ?>css/plugins.css" rel="stylesheet">
    <!-- Colors CSS -->
    <link href="<?php echo $path; ?>styles/maincolors.css" rel="stylesheet">
    <!-- LayerSlider CSS -->
    <link rel="stylesheet" href="<?php echo $path; ?>vendor/layerslider/css/layerslider.css">
    <!-- Switcher Only -->
